...
export default function Navigation() {
  ...
  return (
    <>
      <header className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-outline-variant/20 flex justify-between items-center px-6 py-4">
        ...
        <button className="text-on-surface-variant hover:opacity-80 transition-opacity p-2 rounded-full hover:bg-surface-container-highest active:scale-95 active:duration-100">
          <span className="material-symbols-outlined">notifications</span>
        </button>
      </header>

      {/* Shared Bottom Navigation Bar */}
      <nav className="fixed bottom-0 w-full z-50 rounded-t-3xl bg-surface-container/90 backdrop-blur-md tonal-shift shadow-[0_-4px_24px_rgba(16,185,129,0.06)] border-t border-outline-variant/30 flex justify-around items-center px-4 pt-3 pb-8">
